...
(function (factory) {
  ...
  $.extend(prototype, {
    ...
    renderCropBox: function () {
      ...
      cropBox.oldLeft = cropBox.left = min(max(cropBox.left, canvas.left), (canvas.left + canvas.width - cropBox.width));
      cropBox.oldTop = cropBox.top = min(max(cropBox.top, canvas.top), (canvas.top + canvas.height - cropBox.height));
